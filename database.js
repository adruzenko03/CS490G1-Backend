...
export default class DatabaseService {
  ...
  signupUser(info, userID, callback) {
    this.connection.query(
      `INSERT INTO users (user_id, first_name, last_name, phone_number, street_address, city, state, zip, role)
  ...
  signupCoach(info, userID, callback) {
    //add goal after you make it singular
    this.connection.query(
      `INSERT INTO coach_survey 
